...
var api = {
   ...
   * Last.fm API example.
   */
  getLastfm: function(req, res, next) {
   ...
   * Last.fm API example.
   */
  getLastfm2: function(req, res, next) {
    request = require('request');
    ...
    var token_url = `https://ws.audioscrobbler.com/2.0/?method=auth.gettoken&api_key=${process.env.LASTFM_KEY}`;
    var method = 'auth.getSession';

    request.get(token_url, (err, res, body) => {
   ...
   */
  getFoursquare: function(req, res, next) {
   ...
   * Tumblr API example.
   */
  getTumblr: function(req, res, next) {
   ...
   */
  getScraping: function(req, res, next) {
   ...
   */
  getNewYorkTimes: function(req, res, next) {
    request = require('request');
   ...
   * Twiter API example.
   */
  getTwitter: function(req, res, next) {
    Twit = require('twit');
   ...
   * Post a tweet.
   */
  postTwitter: function(req, res, next) {
   ...
   * Steam API example.
   */
  getSteam: function(req, res, next) {
    request = require('request');
   ...
   * Make a payment.
   */
  postStripe: function(req, res, next) {
   ...
   */
  postTwilio: function(req, res, next) {
   ...
   */
  postClockwork: function(req, res, next) {
    var message = {
   ...
   * Venmo API example.
   */
  getVenmo: function(req, res, next) {
    request = require('request');
   ...
   * Send money.
   */
  postVenmo: function(req, res, next) {
   ...
   */
  getLinkedin: function(req, res, next) {
   ...
   */
  getInstagram: function(req, res, next) {
   ...
   * PayPal SDK example.
   */
  getPayPal: function(req, res, next) {
   ...
   * PayPal SDK example.
   */
  getPayPalSuccess: function(req, res) {
   ...
   * PayPal SDK example.
   */
  getPayPalCancel: function(req, res) {
   ...
   */
  getBitGo: function(req, res, next) {
    BitGo = require('bitgo');
   ...
   */
  postBitGo: function(req, res, next) {
    var bitgo = new BitGo.BitGo({ env: 'test', accessToken: process.env.BITGO_ACCESS_TOKEN });
    var walletId = req.session.walletId;
  ...
  getFileUpload: function(req, res, next) {
    res.render('api/upload', {
      title: 'File Upload'
    });
  },

  postFileUpload: function(req, res, next) {
   ...
   */
  getPinterest: function(req, res, next) {
    request = require('request');
   ...
   * Create a pin.
   */
  postPinterest: function(req, res, next) {
